              ...
              {[...Array(2)].map((_, index) => (
                ...
                >
                  {grandWinners.map((winner) => (
                    <div key={`${winner.id}-${index}`} className="w-[160px] md:w-[240px] shrink-0 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden group relative hover:border-emerald-200 dark:hover:border-emerald-500 transition-colors">
