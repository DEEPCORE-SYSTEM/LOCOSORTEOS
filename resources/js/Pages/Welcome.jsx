...
export default function Welcome({ sorteo }) {
  ...
  const heroBackgrounds = sorteo?.imagen_hero ? [sorteo.imagen_hero, 'https://images.unsplash.com/photo-1559416523-140ddc3d238c?auto=format&fit=crop&q=80&w=1920', 'https://images.unsplash.com/photo-1592982537447-6f2a6a0c5980?auto=format&fit=crop&q=80&w=1920'] : [
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      const targetDate = new Date(sorteo?.fecha_fin || '2026-02-28T20:00:00');
      const now = new Date();
            ...
            <div className="text-center lg:text-left flex-1">
              ...
              <h1 className="text-6xl md:text-8xl font-black text-white mb-6 tracking-tight leading-[1.1] drop-shadow-xl">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-200">
                  {totalPrizesCount > 0 ? totalPrizesCount : '214'} PREMIOS
                </span>
              </h1>
              ...
              {/* Resumen rápido de premios en hero */}
            ...
            <div className="w-full max-w-md shrink-0 relative mt-12 lg:mt-0">
              ...
              <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] border border-white relative relative z-10 transform transition-transform hover:-translate-y-2 duration-300">
                ...
                <div className="absolute -top-5 right-6 bg-[#FF0000] text-white px-4 py-2 rounded-xl shadow-lg transform rotate-3 font-black text-lg border-2 border-white">
                  ¡SOLO S/ {Math.floor(sorteo?.precio_ticket || 40)}!
                </div>
                ...
                <div className="text-center mb-6 pt-4">
                  ...
                  <div className="flex items-start justify-center gap-1 text-slate-900">
                    ...
                    <span className="text-7xl font-black tracking-tighter text-emerald-900">{Math.floor(sorteo?.precio_ticket || 40)}</span>
